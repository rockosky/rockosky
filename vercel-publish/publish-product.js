...
module.exports = async (req, res) => {
  ...
  try {
    ...
    // 3. Duplicate the template, then overwrite the duplicate's
    // content with this photo's real data
    ...
    // 4. Write the result back to Supabase
...
// price, image, and tags, and makes it visible on the storefront.
async function updateProduct(productId, { title, description, priceCents, city, season, hashtags, socialUrl, photographerName, imageUrl }) {
